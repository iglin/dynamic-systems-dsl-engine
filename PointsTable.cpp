...
PointsTable::PointsTable(string *coordName, const map<double, double> &points) : coordName(coordName), points(points) {}

string *PointsTable::getCoordName() const {
    return coordName;
}

void PointsTable::setCoordName(string *coordName) {
